        ...
        methods: {
            ...
            print(o) {
                ...
                this._ajax({
                    ...
                    moneyTotle = parseFloat(moneyTotle).toFixed(2);
                    ...
                    let deliveryDate = o.distributionTimeBegin;
                    let orderCount = o.orderCount;
                    let buyerName = o.buyerName;
                    let contacts = o.receiver;
                    let phoneNumber = o.phonenumber;
                    let address = o.shippingAdd;
                    let categoryName = o.categoryName;
